...
class Data_Plotter:
    def __init__(self):
        ...
        '''
        k = 1     a = 0.0001     entropy = 3.3187162107763704
        k = 1     a = 0.001      entropy = 3.3187245621479615
        k = 1     a = 0.01       entropy = 3.318795663670953
        k = 1     a = 0.1        entropy = 3.319386180714881
        k = 1     a = 1          entropy = 3.3241526890842827
        k = 1     a = 2          entropy = 3.328847440105709
        k = 2     a = 0.0001     entropy = 2.547609907491271
        k = 2     a = 0.001      entropy = 2.547839813044308
        k = 2     a = 0.01       entropy = 2.5498026924739454
        k = 2     a = 0.1        entropy = 2.566278031100472
        k = 2     a = 1          entropy = 2.7009360975871726
        k = 2     a = 2          entropy = 2.830442696512285
        k = 3     a = 0.0001     entropy = 1.997769638996046
        k = 3     a = 0.001      entropy = 2.0053342901888933
        k = 3     a = 0.01       entropy = 2.0764399903171022
        k = 3     a = 0.1        entropy = 2.6487982855067544
        k = 3     a = 1          entropy = 4.55481920691499
        k = 3     a = 2          entropy = 5.054943141977196
        k = 4     a = 0.0001     entropy = 1.7050735634194736
        k = 4     a = 0.001      entropy = 2.0568855677456015
        k = 4     a = 0.01       entropy = 3.778528350290523
        k = 4     a = 0.1        entropy = 5.413973903828152
        k = 4     a = 1          entropy = 5.721792087475998
        k = 4     a = 2          entropy = 5.739294587210711
        k = 5     a = 0.0001     entropy = 3.008058662157925
        k = 5     a = 0.001      entropy = 5.112995354653897
        k = 5     a = 0.01       entropy = 5.68193488811552
        k = 5     a = 0.1        entropy = 5.747956884582386
        k = 5     a = 1          entropy = 5.7543158975980875
        k = 5     a = 2          entropy = 5.754628676702176
        k = 6     a = 0.0001     entropy = 5.613416371178265
        k = 6     a = 0.001      entropy = 5.740412628607464
        k = 6     a = 0.01       entropy = 5.753480429045851
        k = 6     a = 0.1        entropy = 5.754762052929056
        k = 6     a = 1          entropy = 5.754878099470984
        k = 6     a = 2          entropy = 5.754883394196358
        '''
        # self.calc_entropies()
